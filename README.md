...
- 🔭 Working on [***`Delphi`***](https://github.com/henrique-souza/delphi_exercises/),  [`C#`](https://github.com/henrique-souza/csharp_exercises), [`Java`](https://github.com/henrique-souza?tab=repositories&q=java&type=&language=java&sort=), `C`, `Python`, `SQLServer`, `Oracle`
