...
- 🌱 I’m currently learning `Delphi`, `Flutter`, `Azure DevOps`, `SQLServer`, `Node.JS`, `JavaScript`, `TypeScript`, `Angular`, `LESS`, `Ruby`, `Ruby on Rails`, `SQLite`, database and datastructure
- 😄 Pronouns: He/Him
