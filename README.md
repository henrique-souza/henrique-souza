...
- 🔭 I’m currently working on `Delphi`, `C#`, `Java`, `C`, `Python`
- 🌱 I’m currently learning `Flutter`, `Azure DevOps`, `SQLServer`, `Node.JS`, `JavaScript`, `TypeScript`, `Angular`, `LESS`, `Ruby`, `Ruby on Rails`, `SQLite`, database and datastructure
- 😄 Pronouns: He/Him
